...
- **The score hook** sees the form. For a pin it shadows by form, a superset. For a ban it zeroes the form only when every row of the form is banned; with one row allowed the form keeps its score and the detour picks the row.
