...
**Charge with a soul gem** and **Apply a poison** share a "Weapon" cascade in the Then menu, just after Equip, since that is the order of the thing: set the gear, then tend it. Charge comes first.
