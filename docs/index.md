...
**Follower Tactics** is a Skyrim mod that enables easy follower equipment and combat tactics management. It is inspired by similar systems in [Dragon Age: Origins](https://dragonage.fandom.com/wiki/Tactics_(Origins)) and [Pillars of Eternity II](https://www.gamepressure.com/pillars-of-eternity-2/partys-ai/z1ae65).

![Main]({{ "/assets/img/panel/main.png" | relative_url }}){: .screenshot loading="lazy"}

## Features

- Highly customizable [combat tactics]({{ '/tactics/' | relative_url }})
