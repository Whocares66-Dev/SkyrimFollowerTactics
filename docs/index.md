...
**Follower Tactics** is a Skyrim mod for player and follower tactics, follower equipment management, and follower training. It is inspired by similar systems in [Dragon Age: Origins](https://dragonage.fandom.com/wiki/Tactics_(Origins)) and [Pillars of Eternity II](https://www.gamepressure.com/pillars-of-eternity-2/partys-ai/z1ae65).
...
- Reversible [follower training]({{ '/training/' | relative_url }}) for levels, attributes, skills, perks, and spells
- SKSE plugin, no ESP, easy uninstall

## Non-features

This mod focuses on understanding followers, setting their tactics, and training them. It is not a:
