...
- **Ability perks and turning progression off.** That the ability is in the save is read from code (23796 → `AddSpell`); that releasing takes it back off, and that a save made after releasing loads clean without the plugin, is to be seen.
