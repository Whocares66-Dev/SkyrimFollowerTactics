...
State is one record per companion in the SKSE co-save, keyed by plugin + local id: what they've learned (levels, progress, character XP, the reassigning pool), attribute points, and what of it has been applied, perks bought, spells taught. Applying is always "desired minus applied", so repeating it changes nothing.
