...
- **Move the spell math out of `Inventory.h`.** Left over from the `UI.cpp` split (2026-09-25, issue #5): the panel is `game/ui/` now, a file per tab or piece of the rule editor, the shared pieces in `Widgets`; every definition moved as it was.
